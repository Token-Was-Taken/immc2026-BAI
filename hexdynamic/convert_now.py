#!/usr/bin/env python3
"""Convert big.json to viewer format now"""
import json
import math
import os
...
def main():
    input_path = os.path.join(os.path.dirname(__file__), "inputs", "big.json")
    output_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "marker", "big-viewer.json")
    hex_size = 62
